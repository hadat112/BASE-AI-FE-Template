...
const ModalContent = React.forwardRef<
  ...
  ModalContentProps
>(({ className, children, closeable = true, isMobile, ...props }, ref) => (
  <ModalPortal>
    <ModalOverlay />
